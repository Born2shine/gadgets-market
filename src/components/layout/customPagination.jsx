...
<div className="flex mt-20 justify-center">
    <Pagination
            ...
            activeClass="z-10 inline-flex items-center border-indigo-500 bg-indigo-50 text-sm font-medium text-indigo-600 focus:z-20"
            activeLinkClassName="z-10 inline-flex items-center border-indigo-500 bg-indigo-50 text-sm font-medium text-indigo-600 focus:z-20"
            />
</div> );
}
