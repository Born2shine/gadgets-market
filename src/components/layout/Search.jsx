...
console.log('show------')
  ...
  return (
    <form onSubmit={submitHandler} className="flex flex-nowrap items-center w-full order-last md:order-none mt-5 md:mt-0 md:w-2/4 lg:w-2/4 lg: ml-16">
      <input
        className="flex-grow appearance-none border border-gray-200 bg-gray-100 rounded-md mr-2 py-2 px-3   hover:shadow-md focus:outline-none focus:shadow-lg transition-all duration-1000 ease-out"
        type="text"
